...
date:       2020-11-20 				# 时间
author:     pfan8 						# 作者
header-img: img/app-shsf2.jpg 	#这篇文章标题背景图片
catalog: true 						# 是否归档
tags:								#标签
    - 工具
---
...
首先，透明在`iTerm2 -> Preferences -> Profiles -> Windows`里调节Transparency，调节到自己喜欢的程度就好，觉得比较花甚至可以不设置

然后启动的ascii画，有2个推荐：
1. 挑选自己喜欢的ascii画，保存到本地某个位置，假设在`/Users/mac/ascii_pic.txt`，那么就在.zshrc中添加
   ...
   lolcat需要自行安装
2. random-quote，结合cowsay也很hacker，把`quote | cowsay`加入zshrc最后一行，会随机生成一句话，效果如下
